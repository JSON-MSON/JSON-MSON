...
Aspiring IT Support & Security Analyst transitioning into cybersecurity operations, backed by a **Google Cybersecurity Professional Certificate** and **CompTIA Security+** (in progress). I built a home lab from scratch — isolated VM infrastructure, attack simulation, defensive tooling, and identity administration — and documented all of it here.
